...
func Test_NewRCServer_json(t *testing.T) {
	//_rongcloud := CreateRongCloud("pvxdm17jp33or", "Kz4oaiZEek")
	_rongcloud := CreateRongCloud("8luwapkv8jjzl", "1d3jpYSh5179H")
...
func Test_User_GetToken(t *testing.T) {
	...
	if result, tokenError := rongcloud.User.GetToken(userId, name, portraitUri); tokenError != nil || result == nil {
		fmt.Println(result, "=========", tokenError)
		t.Error("GetToken: fail.")
	} else {
		//1ZfuZc+hSTJ3Aimfr4UfWJhm6ahOPXgN968Sskv5NM2IfaMahRIO3LF0eMrGCCUtuDeUmVLlx4snzAzwJ/d68SUMenu6AbV5
		//ws9eDx6zRyhVOB1PycEDX0DsvgMMd6L5jED8hNqNVNdGuWynHTc7Bf1BimDKVI3mSIJz12g40u9K2/sVRYeeaw==
		//w2yTa7sqRZ5pHgnC7OTNq/5uUQ9DDjon579ZU0BZ2wbxJ0870nXBz2XAhiN5wNrGQt4cm7HRJLj07Ucs8obr7toBH1VUeDze
		//2CREKlHh8WDFh+fnr5pwM5hm6ahOPXgN968Sskv5NM2IfaMahRIO3F5xk8ASysfo/FT7xViqStonzAzwJ/d68SUMenu6AbV5m
		fmt.Println(result, "====tokenError=====", tokenError)
		t.Log("GetToken: pass.", result, "  ==", tokenError)
	}
...
//		fmt.Println("result:==", result, "tokenError==", tokenError)
//		t.Error("Broadcast: fail.===================================================")
//	} else {
//		fmt.Println("result:=else=", result, "tokenError=else==++++++++++++++", tokenError)
...
func Test_Push_BroadcastPush(t *testing.T) {
	jsonStr = readFile("../PushMessage.json")
